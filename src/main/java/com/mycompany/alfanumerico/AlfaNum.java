...
public class AlfaNum {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\55\0\1\1\2\0\1\2\10\0\1\3\7\0\1\4"+
    "\3\0\1\5\3\0\1\6\5\0\1\7\5\0\1\10"+
    "\13\0\1\4\3\0\1\5\3\0\1\6\5\0\1\7"+
    "\5\0\1\10\272\0\2\6\u01ce\0";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    ...
    "\0\22\0\110\0\121\0\132\0\143\0\154\0\165\0\176"+
    "\0\33";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\2\2\1\3\1\2\1\4\4\2\12\0\1\5\14\0"+
    "\1\6\6\0\1\7\13\0\1\10\4\0\1\11\15\0"+
    "\1\12\11\0\1\13\4\0\1\14\11\0\1\15\11\0"+
    "\1\16\11\0\1\17\11\0\1\20\4\0\1\21\4\0";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 =
    "\1\0\1\11\2\1\2\0\1\1\10\0\1\1\1\0";
   ...
   */
  public AlfaNum(java.io.Reader in) {
    	  yyline = 1; 
    	yycolumn = 1; 
    this.zzReader = in;
  }
 ...
 //System.out.println("Numeros:" + getContNum());
  ...
  public static void main(String[] argv) {
    if (argv.length == 0) {
      System.out.println("Usage : java AlfaNum [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        AlfaNum scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new AlfaNum(reader);
